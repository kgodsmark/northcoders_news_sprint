...
function saveArticles() {
  const articles = [
    { title: 'Cats are great', body: 'something', belongs_to: 'cats', created_by: 'northcoder' },
    { title: 'Football is fun', body: 'something', belongs_to: 'football', created_by: 'northcoder' }
